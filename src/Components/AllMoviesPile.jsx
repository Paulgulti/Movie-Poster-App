...
const AllMoviesPile = ({ movie }) => {
    ...
    return (
        <div className=' p-5 bg-cyan-950 cursor-pointer'>
            <div className='image-cont '>
                <img className=' object-cover w-[100%]' src={movie.poster_path ? `${baseImageUrl}${movie.poster_path}` : unavailableImage} alt="" />
            </div>
